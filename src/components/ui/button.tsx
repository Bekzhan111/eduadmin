  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-gray-300 dark:border-gray-700 bg-transparent shadow-sm hover:bg-gray-50 dark:hover:bg-slate-800',
        secondary: 'bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-gray-100 shadow-sm hover:bg-gray-200 dark:hover:bg-slate-700',
        ghost: 'hover:bg-gray-50 dark:hover:bg-slate-800',
